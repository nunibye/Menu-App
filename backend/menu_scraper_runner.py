...
def menu_scrape():
    ...
    halls_html = ['text=College Nine/John R. Lewis Dining Hall', 'text=Cowell/Stevenson Dining Hall', 'text=Crown/Merrill Dining Hall', 'text=Porter/Kresge Dining Hall', 'text=Rachel Carson/Oakes Dining Hall']
    dates = ["Today", "Tomorrow", "Day after tomorrow"]
    halls_name = ['Nine', 'Cowell', 'Merrill', 'Porter', 'Oakes']
