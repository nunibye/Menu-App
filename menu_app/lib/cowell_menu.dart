// Displays Cowell college's menu.
                  ...
                  setState(() {
                    ...
                    if (_currentlySelected == "Tomorrow") {
                      ...
                      futureBreakfast = main_page
                          .fetchAlbum('Cowell', 'Breakfast', day: "Tomorrow");
                      futureLunch = main_page.fetchAlbum('Cowell', 'Lunch',
                          day: "Tomorrow");
                      futureDinner = main_page.fetchAlbum('Cowell', 'Dinner',
                          day: "Tomorrow");
                      futureLateNight = main_page
                          .fetchAlbum('Cowell', 'Late%20Night', day: "Tomorrow");
                      ...
                      // print(_currentlySelected);
                      futureBreakfast =
                          main_page.fetchAlbum('Cowell', 'Breakfast');
                      futureLunch = main_page.fetchAlbum('Cowell', 'Lunch');
                      futureDinner = main_page.fetchAlbum('Cowell', 'Dinner');
                      futureLateNight =
                          main_page.fetchAlbum('Cowell', 'Late%20Night');
                    }
