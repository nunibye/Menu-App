                  ...
                  setState(() {
                    ...
                    if (_currentlySelected == "Tomorrow") {
                      ...
                      futureBreakfast = main_page
                          .fetchAlbum('Nine', 'Breakfast', day: "Tomorrow");
                      futureLunch = main_page.fetchAlbum('Nine', 'Lunch',
                          day: "Tomorrow");
                      futureDinner = main_page.fetchAlbum('Nine', 'Dinner',
                          day: "Tomorrow");
                      futureLateNight = main_page
                          .fetchAlbum('Nine', 'Late%20Night', day: "Tomorrow");
                      ...
                      // print(_currentlySelected);
                      futureBreakfast =
                          main_page.fetchAlbum('Nine', 'Breakfast');
                      futureLunch = main_page.fetchAlbum('Nine', 'Lunch');
                      futureDinner = main_page.fetchAlbum('Nine', 'Dinner');
                      futureLateNight =
                          main_page.fetchAlbum('Nine', 'Late%20Night');
                    }
